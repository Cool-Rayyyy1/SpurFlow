...
class LatentDiffusionImageEdit(LatentDiffusionTextImage):
    """Latent diffusion with FLUX Kontext-style reference image conditioning."""
    ...
    def val_step(self, data, test_cfg_override=dict(), **kwargs):
        ...
        with torch.no_grad():
            ...
            if distilled_guidance_scale is not None:
                ...
                embed_kwargs.update(guidance=distilled_guidance_scale)
