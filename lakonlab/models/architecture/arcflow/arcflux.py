...
class ArcFluxTransformer2DModel(_ArcFluxTransformer2DModel):
    ...
    def _prepare_latent_image_ids(height, width, device, dtype, modality=0):
        """
        Copied from Diffusers. modality=1 marks Kontext reference tokens.
        """
    ...
    def forward(
        ...
        # FLUX Kontext: concatenate reference image tokens along sequence dim.
        ...
        output['means'] = output['means'][:, :target_seq_len].permute(0, 2, 3, 1).reshape(
