...
#   TOTAL_ITERS=50000 bash train_flux_data.sh
...
echo "Launching EditFlow data DDP: nproc_per_node=${NUM_GPUS}  total_iters=${TOTAL_ITERS}  run=${RUN_NAME}  CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES}"
