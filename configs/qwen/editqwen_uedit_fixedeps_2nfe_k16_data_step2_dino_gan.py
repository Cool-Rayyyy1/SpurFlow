...
# Qwen-Image-Edit fixed-eps PIID + step-2 TDM-style DINO feature GAN (no alpha).
# Counterpart of configs/kontext/editflux_uedit_fixedeps_2nfe_k16_data_step2_dino_gan.py:
#   ArcFlowEditImitationStep2GAN + DinoFeatureDiscriminator
#   shared global/local crops, gan_grad_step2_only=True
#   student_u = path_epsilon - x_ref - pred_delta
name = 'gmqwen_uedit_fixedeps_k16_2nfe_pico400k_step2_dino_gan'
...
model = dict(
    type='LatentDiffusionQwenImageEditStep2DinoFeatureGAN',
    vae=dict(
