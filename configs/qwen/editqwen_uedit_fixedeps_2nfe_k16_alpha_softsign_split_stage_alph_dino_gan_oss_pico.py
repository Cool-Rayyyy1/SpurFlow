_base_ = ['./editqwen_uedit_fixedeps_2nfe_k16_alpha_softsign_split_stage_alph_dino_gan.py']

# 70% oss_edit banana-task pairs + 30% pico-banana-400k.
# Qwen Softsign-01 alpha student (ArcQwenEditAlphaSoftsign01ImageTransformer2DModel).
...
name = 'gmqwen_uedit_fixedeps_alpha_softsign01_k16_2nfe_oss70_pico30_split_stage_alph_dino_gan'
...
# Training-time vis: ImgEdit 9 cats x 5 + GEdit-v2 x 3.
# Qwen resize instead of Kontext buckets.
sample_eval = dict(
    _delete_=True,
