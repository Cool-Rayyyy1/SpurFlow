_base_ = ['./editflux2_klein_uedit_fixedeps_2nfe_k16_alpha_softsign_split_stage_alph_dino_gan.py']

# 70% oss_edit banana-task pairs + 30% pico-banana-400k.
# FLUX.2-klein-base Softsign-01 alpha student
...
name = (
    ...
    'oss70_pico30_split_stage_alph_dino_gan')
