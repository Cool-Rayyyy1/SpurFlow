_base_ = ['./editflux2_klein_uedit_fixedeps_2nfe_k16_alpha_softsign_step2_alph_dino_gan.py']

# 30% oss_edit banana-task pairs + 70% pico-banana-400k.
# FLUX.2-klein-base Softsign-01 alpha student + independent step-2 DINO GAN
...
name = (
    ...
    'oss30_pico70_step2_alph_dino_gan')
...
# flux2 resize instead of Kontext buckets.
sample_eval = dict(
    _delete_=True,
