# ~65GB VRAM (Kontext image editing)
...
model = dict(
    ...
    text_encoder=dict(
        ...
        from_pretrained='/mnt/afs_zhangyunzhe/pretrained_models/FLUX.1-Kontext-dev',
    )
)
train_cfg = dict(
    # grad_accum_batch_size=1,  # uncomment to reduce VRAM usage
