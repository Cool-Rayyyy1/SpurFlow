...
# `train_flux_edit_fixedeps_data_oss.sh`
# Same non-split ArcFlowEditImitation (no alpha) as the pico-only baseline
# (ArcFluxEditNewTransformer2DModel), but:
#   - init from FLUX.1-Kontext-dev
...
name = 'gmkontext_uedit_fixedeps_k16_2nfe_oss30_pico70'
