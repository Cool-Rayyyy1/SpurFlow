...
# `train_flux_edit_data.sh` overrides name/work_dir/resume_from from NFE
# (e.g. gmkontext_uedit_k16_2nfe_pico400k).
name = 'gmkontext_uedit_k16_2nfe_pico400k'
...
model = dict(
    ...
    diffusion=dict(
        ...
        denoising=dict(
            type='ArcFluxEditTransformer2DModel',
            patch_size=2,
            freeze=True,
            freeze_exclude=[
                'proj_out_deltax',
