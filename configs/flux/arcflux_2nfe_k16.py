...
# `train_flux.sh` overrides name/work_dir/resume_from from NFE (e.g. gmflux_k16_4nfe_train3m).
name = 'gmflux_k16_2nfe_train3m'
flux_model = '/mnt/afs_zhangyunzhe/pretrained_models/FLUX-1-dev'
flux_transformer = f'{flux_model}/transformer/diffusion_pytorch_model.safetensors.index.json'

model = dict(
    type='LatentDiffusionTextImage',
    vae=dict(
        type='PretrainedVAEDecoder',
        from_pretrained=flux_model,
        subfolder='vae',
        freeze=True,
