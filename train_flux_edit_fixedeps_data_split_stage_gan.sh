...
#   Fake: step-2 t=0 latent -> Kontext unpatchify + VAE decode -> DINOv3 Resize(224)
#   Real: pico edited_images -> DINOv3 Resize(224)
#   DINOv3: D(x) = 0.25*s_global + 1.0*mean(s_patch)
#
#   bash train_flux_edit_fixedeps_data_split_stage_gan.sh              # default: 2 GPUs
#   bash train_flux_edit_fixedeps_data_split_stage_gan.sh 8
#   GPU_IDS=0,1,2,3 bash train_flux_edit_fixedeps_data_split_stage_gan.sh 4
