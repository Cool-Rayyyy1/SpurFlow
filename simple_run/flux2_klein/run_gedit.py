#!/usr/bin/env python3
"""Official FLUX.2-klein-base-9B on GEdit-v2.

HF: https://huggingface.co/black-forest-labs/FLUX.2-klein-base-9B
Resize: flux2. Sharding: metadata[split_id::split_num].

  CUDA_VISIBLE_DEVICES=0 python simple_run/flux2_klein/run_gedit.py --split_id 0 --split_num 8
"""
...
if __name__ == "__main__":
    run_gedit("klein", defaults, extra_sys_path=[str(HERE), str(SIMPLE_RUN)])
