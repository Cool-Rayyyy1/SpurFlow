...
# Default ckpt: checkpoints/gmkontext_uedit_teacherinv_eps_k16_2nfe_pico400k/20260624_174422/iter_10000.pth
#
...
#   CKPT=/path/to/iter_10000.pth bash evaluation/run_gmkontext_uedit_teacherinv_eps_infer.sh
...
export CKPT="${CKPT:-${EDITFLOW_DIR}/checkpoints/gmkontext_uedit_teacherinv_eps_k16_2nfe_pico400k/20260624_174422/iter_10000.pth}"
export RUN_TAG="${RUN_TAG:-gmkontext_uedit_teacherinv_eps_k16_2nfe_pico400k_20260624_iter_10000}"
...
# GPT scoring: gpt-4o-2024-11-20 (same pinned model as earlier ImgEdit-Bench runs).
export OPENAI_SCORING_MODEL="${OPENAI_SCORING_MODEL:-gpt-4o-2024-11-20}"
