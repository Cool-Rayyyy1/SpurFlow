...
#
# Default ckpt: 20260721_021700/iter_6000.pth
#
# Usage:
...
export CKPT="${CKPT:-${EDITFLOW_DIR}/checkpoints/gmkontext_uedit_fixedeps_k16_2nfe_pico400k_split_stage_dual_lora_teacher_x0/20260721_021700/iter_6000.pth}"
