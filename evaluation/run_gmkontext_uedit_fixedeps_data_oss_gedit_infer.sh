#!/usr/bin/env bash
# GEdit-v2 student inference for train_flux_edit_fixedeps_data_oss.sh
...
#
# Usage:
#   bash evaluation/run_gmkontext_uedit_fixedeps_data_oss_gedit_infer.sh
#   CKPT=/path/to/iter_XXXX.pth bash evaluation/run_gmkontext_uedit_fixedeps_data_oss_gedit_infer.sh
#   MAX_SAMPLES=8 bash evaluation/run_gmkontext_uedit_fixedeps_data_oss_gedit_infer.sh
...
echo "[gmkontext_uedit_fixedeps_data_oss / GEdit-v2] CONFIG=${CONFIG}"
echo "[gmkontext_uedit_fixedeps_data_oss / GEdit-v2] CKPT=${CKPT}"
echo "[gmkontext_uedit_fixedeps_data_oss / GEdit-v2] RUN_TAG=${RUN_TAG}"
echo "[gmkontext_uedit_fixedeps_data_oss / GEdit-v2] NFE=${STUDENT_NFE}  guidance=${STUDENT_GUIDANCE}  resize=${STUDENT_RESIZE_MODE}"
